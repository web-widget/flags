...
export async function SingleProduct({ showRating }: { showRating: boolean }) {
  const product = await fetch(
    `https://app-playground-api.vercel.app/api/products?id=1`,
  ...
  return (
    <div className="grid grid-cols-4 gap-6">
      ...
      <div className="col-span-full space-y-4 md:order-2 md:col-span-2">
        ...
        {showRating ? <ProductRating rating={product.rating} /> : null}
